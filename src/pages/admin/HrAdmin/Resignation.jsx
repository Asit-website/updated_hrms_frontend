...
const Resignation = () => {
  ...
  const { getResignation, resignation, allEmp, createResignation, deleteResignation, updateResignation } = useMain();
  ...
  const handleFormSubmit = async (data) => {
    ...
    if (res.success) {
      await getResignation();
      toast.success(`Resigination ${isEdit ? "updated" : "created"} for ${data.Employee}`);
    } else {
      toast.error(`Failed to ${isEdit ? "update" : "create"} Resigination for ${data.Employee}`);
    }
