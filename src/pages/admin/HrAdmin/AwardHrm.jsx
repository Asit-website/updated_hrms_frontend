...
const Award = () => {
  const { getAward, awards, allActiveEmployee, postAward, updateAward, deleteAward } = useMain();
  ...
  const endIndex = Math.min(startIndex + itemsPerPage, awards?.length);
  ...
  const fields = [
    ...
    },
    {
      ...
      type: "number",
      disabled: false,
      ...(isEdit && { defaultValue: editData?.rating }),
    },
    {
      name: "date",
      label: "Date",
