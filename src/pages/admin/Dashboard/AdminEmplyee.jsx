              ...
              <div className="flex flex-col gap-2 max-w-[1440px] w-full mx-auto">
                {location?.state ? (<div className="hrDsPa">
                  ...
                  <NavLink to={`/adminDash/HRM`}>
                    <span className="hover:text-[#1567FF] cursor-pointer text-xl ml-5">Dashboard</span>
                  </NavLink>
                  <span>
                    <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1747743027/chevron_right_ztbdvq.png" alt="" />
                  </span>{" "}
                  <span className="text-[#1567FF] cursor-pointer" >Active Employee</span>
                </div>) : (<p className="text-[24px] text-center font-semibold leading-[32px] lg:text-left text-[#101820] ml-5">Active Employee</p>)}
