...
const LeadFile2 = () => {
  ...
  const handleFileSubmit = async (e) => {
    ...
    if (excelFile !== null) {
      ...
      navigate(user?.role === "ADMIN" ? "/adminDash/myLead" : "/employeeDash/myLead");
        ...
        <div className="w-full bg-[#f5f5f5]">
          ...
          <div className="pt-8 pr-4 pb-7 pl-[16px] relative w-full">
            <div className="flex items-center justify-between">
              ...
              <NavLink to={user?.role === "ADMIN" ? "/adminDash/myLead" : "/employeeDash/myLead"}><button className="bg-[#2563eb] text-white text-[16px] font-medium px-4 py-[6px] rounded-md hover:bg-blue-700">
