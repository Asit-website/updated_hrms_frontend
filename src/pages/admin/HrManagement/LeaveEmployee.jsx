    ...
    <>
      <div className="employee-dash h-full">
        ...
        <div className="w-full bg-[#f5f5f5]">
          ...
          <div className="pt-[32px] pr-[20px] pb-[32px] pl-[24px] relative w-full">
            <div className="flex-col">
              ...
              <div className="flex flex-col gap-2 max-w-[1440px] w-full mx-auto">
                ...
                {location.state ? (<div className="hrDsPa">
                  ...
                  <span className="text-[#1567FF] cursor-pointer">Employees on Leave</span>
                </div>) : (<p className="text-[20px] font-normal leading-[24px] tracking-normal text-left text-[#060606]
