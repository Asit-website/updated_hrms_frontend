        ...
        <div className="tm">
          ...
          <div className="em">
            ...
            <div className="flex-col">
              {/* first sec */}
              <div className="flex items-center gap-6 border-t border-gray-200 rounded-lg mt-10 bg-white p-3">
                {item.map((e, index) => (
                  <div
              ...
              >
                <div className="flex flex-col gap-7.5">
                  <div className="flex w-full justify-between">
                    <div className="bg-white max-w-[48%] w-full p-4 rounded-lg">
                          ...
                          <div className="flex flex-col gap-[20px] mt-[10px] mb-[10px]">
                            ...
                            <div className="makethisflex1">
                              <div className=" w-full try">
                                <label
                                  for="pan"
                                  className="!flex !flex-row  font-medium text-[#1B2533] text-[14px] font-normal leading-[20px] tracking-[0.0025em]"
                                >
                            ...
                            <label htmlFor="" className="text-[#1B2533] text-[14px] font-normal leading-[20px] tracking-[0.0025em]">
                        ...
                        <div className="w-full mt-2 form2wrap">
                          ...
                          <div className="flex w-full">
                            <div className=" w-full try">
                              ...
                              <label htmlFor="currentAddress" className="block mb-0 font-medium">
                                Current Residence Address
                              </label>
                              {/* <input
                                type="text"
                          ...
                          <div className="flex w-full flex-col">
                            ...
                            {/* <label className="flex items-center space-x-2 mt-2 mb-2">
                                <input
                                  type="checkbox"
                                  checked={value3.currentStateStatus}
                                  onChange={(e) => {
                                    const checked = e.target.checked;
                                    setValue3((prev) => ({
                                      ...prev,
                                      currentStateStatus: checked,
                                      perState: checked ? prev.currentState : "", 
                                    }));
                                  }}
                                />
                                <span className="text-sm">Permanent State same as current</span>
                              </label> */}
                          </div>
                          ...
                          <div className="flex w-full">
                            <div className=" w-full try">
                              <div className="flex items-center">
                                ...
                                <label htmlFor="residence" className="block mb-0 font-medium">
                                  Permanent Residence Address
                                </label>
                        ...
                        <div className="wrap1">
                          ...
                          <div className="thiddrapgsingl">
                            ...
                            <div className="drag-area">
                              <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1747395640/upload-file_eeafaw.png" alt="" />
